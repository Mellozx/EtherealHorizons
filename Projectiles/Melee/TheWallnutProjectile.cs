...
{
	public class TheWallnutProjectile : ModProjectile
	{
		// The folder path to the flail chain sprite
		private const string ChainTexturePath = "EtherealHorizons/Projectiles/Melee/TheWallnutChainProjectile";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("The Wallnut"); // Set the projectile name to Example Flail Ball
		}
